          ...
          <TabsContent value="usage" className="mt-6">
            <Card className="p-6">
              ...
              <p className="text-muted-foreground mb-4">
                Import and use the DonutChart component in your React application:
              </p>
              ...
              <div className="grid gap-4">
                <div>
                  ...
                  <ul className="list-disc list-inside mt-2 text-muted-foreground">
                    <li><code>data</code>: Array of objects with label and value properties</li>
          ...
          <TabsContent value="examples" className="mt-6">
            <Card className="p-6">
              ...
              <div className="grid gap-8">
                <div>
                  <h4 className="font-medium mb-4">Basic Donut Chart</h4>
                ...
                <div>
                  <h4 className="font-medium mb-4">Styled Donut Chart</h4>
                  <div className="bg-secondary/50 rounded-lg p-6">
                    <D3DonutChart
                      width={600}
                      height={300}
