          ...
          <TabsContent value="usage" className="mt-6">
            <Card className="p-6">
              ...
              <p className="text-muted-foreground mb-4">
                Import and use the BarChart component in your React application:
              </p>
          ...
          <TabsContent value="examples" className="mt-6">
            <Card className="p-6">
              ...
              <div className="grid gap-8">
                <div>
                  <h4 className="font-medium mb-4">Basic Bar Chart</h4>
                ...
                <div>
                  <h4 className="font-medium mb-4">Styled Bar Chart</h4>
                  <div className="bg-secondary/50 rounded-lg p-6">
                    <D3BarChart
                      width={600}
                      height={300}
