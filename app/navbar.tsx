...
export function Navbar() {
  return (
    <div className="sticky top-2 z-50 mx-4 sm:mx-6 lg:mx-8">
      <nav className="flex items-center justify-between px-4 py-3 bg-background/80 dark:bg-[#1B1B1B]/80 backdrop-blur-md backdrop-saturate-150 border border-border/40 rounded-lg shadow-sm ring-1 ring-black/5 dark:ring-white/10">
